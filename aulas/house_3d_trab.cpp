...
void draw_roof() {
    ...
    const float red = 0.65f;
    const float green = 0.16f;
    const float blue = 0.16f;
...
void draw_house() {
    ...
    glTranslatef(0.0f, 0.0f, -7.0f); // translada a casa para trás, para que ela fique visível na tela (-7.0f no eixo z)
